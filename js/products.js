...
const CONFIG = {
  ...
  ranges: {
    dried: { label: "Dried Meat",             short: "DRIED MEAT" },
    fresh: { label: "Venison & Meat Products", short: "VENISON & MEAT (FRESH / FROZEN)" },
  },
...
const PRODUCTS = [
  ...
  /* ---- Venison › Kudu (dried) ---- */
  { range:"dried", category:"Venison", meat:"Kudu", type:"Biltong", name:"Kudu Biltong",
    ...
    soldOut:true },
  { range:"dried", category:"Venison", meat:"Kudu", type:"Droëwors", name:"Kudu Droëwors",
    ...
    soldOut:true },
  { range:"dried", category:"Venison", meat:"Kudu", type:"Sweet Chili Bites", name:"Kudu Sweet Chili Bites",
  ...
  /* ---- Venison › Springbok (dried) ---- */
  { range:"dried", category:"Venison", meat:"Springbok", type:"Biltong", name:"Springbok Biltong",
    ...
    soldOut:true },
  { range:"dried", category:"Venison", meat:"Springbok", type:"Droëwors", name:"Springbok Droëwors",
    ...
    soldOut:true },
  { range:"dried", category:"Venison", meat:"Springbok", type:"Sweet Chili Bites", name:"Springbok Sweet Chili Bites",
  ...
  /* ---- Pork (dried) ---- */
  { range:"dried", category:"Pork", meat:"Pork", type:"Cabanossi", name:"Cabanossi",
    ...
    soldOut:true },
  { range:"dried", category:"Pork", meat:"Pork", type:"Cabanossi", name:"Cherry Cabanossi",
    weight:"100g", unit:"pack", price:35, image:"images/products/placeholder.jpg",
    ...
    soldOut:true },
  { range:"dried", category:"Pork", meat:"Pork", type:"Salami", name:"Salami Sticks",
    weight:"100g", unit:"pack", price:35, image:"images/products/placeholder.jpg",
  ...
  /* ===================================================================== *
   *  VENISON & MEAT PRODUCTS  (FRESH / FROZEN)                            *
  ...
  /* ---- Venison › Kudu (fresh) ---- */
  { range:"fresh", category:"Venison", meat:"Kudu", type:"Mince", name:"Kudu Mince",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Kudu", type:"Steaks", name:"Kudu Steaks",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Kudu", type:"Wors", name:"Kudu Wors",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Kudu", type:"Patties", name:"Kudu Patties",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Kudu", type:"Cheese Grillers", name:"Kudu Cheese Grillers",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Kudu", type:"Chili Cheese Grillers", name:"Kudu Chili Cheese Grillers",
  ...
  /* ---- Venison › Springbok (fresh) ---- */
  { range:"fresh", category:"Venison", meat:"Springbok", type:"Mince", name:"Springbok Mince",
    weight:"1kg", unit:"kg", price:120, image:"images/products/placeholder.jpg",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Springbok", type:"Steaks", name:"Springbok Steaks",
    weight:"per kg", unit:"kg", price:180, image:"images/products/placeholder.jpg",
  ...
  { range:"fresh", category:"Venison", meat:"Warthog", type:"Mince", name:"Warthog Mince",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Warthog", type:"Wors", name:"Warthog Wors",
    weight:"1kg", unit:"kg", price:110, image:"images/products/placeholder.jpg",
    ...
    soldOut:true },
  { range:"fresh", category:"Venison", meat:"Warthog", type:"Patties", name:"Warthog Patties",
    weight:"4 patties", unit:"pack", price:100, image:"images/products/placeholder.jpg",
  ...
  /* ---- Pork (fresh) ---- */
  { range:"fresh", category:"Pork", meat:"Pork", type:"Sausage", name:"Pork Sausage",
    weight:"1kg", unit:"kg", price:85, image:"images/products/placeholder.jpg",
    description:"Fresh pork sausage for the pan or braai.",
    about:"Classic, comforting pork bangers — breakfast and braai essential.",
    soldOut:true },
  { range:"fresh", category:"Pork", meat:"Pork", type:"Patties", name:"Pork Patties",
    weight:"4 patties", unit:"pack", price:90, image:"images/products/placeholder.jpg",
    description:"Ready-to-grill pork burger patties.",
    about:"Tender, savoury pork burgers ready to cook.",
    soldOut:true },
];
